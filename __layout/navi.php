    ...
    <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="index.php" style="color:#FFF;"> <h5>OAP GPS</h5> </a>
        ...
        <?php 
            ...
            <li class="nav-item text-nowrap">
                <a class="nav-link" href="#" style="color:#FFF;"><h5>รหัสผ่านหมดอายุวันที่ <?= DateThai(showDateExpired()); ?></h5></a>
            </li>
        </ul>
        <?php }?>
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                                        <a class="nav-link" href="password.php">
                                            <span data-feather="file-text"></span> แก้ไขรหัสผ่าน
                                        </a>
                                </li>
                            ...
                            <?php } else { ?>
                                <li class="nav-item">
                                        <a class="nav-link" href="editprofile.php">
                                            <span data-feather="file-text"></span> แก้ไขข้อมูลส่วนตัว
                                        </a>
                                </li>
                           <?php }
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= $approve; ?>" href="approve.php">
                                <span data-feather="users"></span> รายการการขอใช้งานระบบ 
                                <span class="badge badge-danger"><?= countNonApprove(); ?></span>
                                <span class="sr-only">unread messages</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $userExpired; ?>" href="userexpaired.php">
                                <span data-feather="users"></span> รายการบัญชีหมดอายุ 
                            </a>
                        </li>
                        <?php }
                        if ($show['job'] == 1) {?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="accident.php">
                                <span data-feather="file"></span> รายงานปัญหาระหว่างขนย้ายวัสดุกัมมันตรังสี
                            </a>
                        </li>
                        <?php } ?>
                    </ul>
                    ...
                    <?php
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= $report; ?>" href="report.php">
                                <span data-feather="file-text"></span> รายงานการขนส่งวัสดุกัมมันตรังสี
                            </a>
                        </li>
                        <?php }
                        if ($show['accidentreport'] == 1) {?>
