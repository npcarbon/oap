...
<div id="map_canvas"></div>
 <div id="showDD" style="margin:auto;padding-top:5px;">  
  ...
  <textarea name="place_value" class="form-control" rows="2" id="place_value" style="width:380px;"></textarea>  
    <br />
    Latitude  
    <input disabled name="lat_value" class="form-control" type="text" id="lat_value" value="0" />  
    Longitude  
    <input disabled name="lon_value" class="form-control" type="text" id="lon_value" value="0" />  
     <br>
</div> 
