                                    ...
                                    <form action"" method="POST">
                                        ...
                                        <?php
                                            if (isset($_POST['traders'])) { 
                                                ...
                                                <?php
                                                echo '
                                                <input type="text" name="license" hidden value="'.$_POST['traders'].'">
                                                '. getReport($_POST['traders'], $_POST['from_date'], $_POST['to_date']) .' 
                                                <a target="_blank" type="button" class="btn btn-success btn-sm" href="../pdf.php?license='. $_POST["traders"].'&&from_date='.$_POST["from_date"].'&&to_date='.$_POST["to_date"].'">PDF</a>
